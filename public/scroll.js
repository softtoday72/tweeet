        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="col px-0" style="max-width: 80%;">
                    ...
                    <small>Reply To<span style="color:#00adff">@${tweet.User.account}</span></small>
                </div>
                <form method="POST" action="/tweets/${tweet.id}/replies">
                    <div class="row mt-3">
                        ...
                        <div class="col mx-0 px-0">
                            <textarea name="comment" class="border-0 mt-2 mx-0 px-0" style="width:100%; border: none;outline: none;resize:none" placeholder="Tweeet your reply" id="floatingTextarea2" rows="4" maxlength="140" required></textarea>
                        </div>
                    </div>
                    <div class="text-end">
                        <button type="submit" class="btn myBtn rounded-pill " >Reply</button>
                    </div>
                </form>
            </div>
        </div>
